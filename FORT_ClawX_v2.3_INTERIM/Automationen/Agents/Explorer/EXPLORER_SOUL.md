...
- **Web-Recherche:** Nutze `web-search` für aktuelle Informationen und Themenfindung.
...
## Kompetenzen & Tools
- `web-search` - Web-Recherche und Informationsfindung
...
- **Dateiformat:** `<Suchbegriff>_<TIMESTAMP>.md` 
